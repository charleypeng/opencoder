#!/usr/bin/env node
// Release notes extraction (TASK-M10-04). Reads the version's section from
// the changelog and writes it to a file used as the GitHub Release body:
...
// "[Unreleased]" section is used as the pre-release fallback (TASK-M10-06
// renames it to the released version). Exits 1 when neither section exists.
