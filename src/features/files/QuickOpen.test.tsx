// L2 tests for the quick open dialog (TASK-M4-04): opens with the search
// input focused, an empty query shows the per-server recent files, typing
// debounces 150ms and fetches /find/file (rapid keystrokes collapse into
// one request, stale in-flight responses are dropped), ↑↓ wrap and Enter
// opens (viewer tab + recent memory + callbacks) while Esc closes, a click
// opens the same way, and the loading / no-matches / no-recent states
// render. Reopening resets the query and cancels pending searches.
