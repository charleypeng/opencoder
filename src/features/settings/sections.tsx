...
export interface SettingsSectionDef {
  ...
  /** Icon path data rendered by the shared 16px stroke Icon. */
  iconPath: string;
...
/** 16px stroke icon for one nav entry. Rendered inside a component tree —
 *  never at module scope, where dev-mode component creation has no owner
 *  ("computations created outside a createRoot" warnings). */
export function Icon(props: { path: string }): JSX.Element {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
const ICON_PATHS: Record<SectionId, string> = {
  ...
  appearance: "M12 2.7 17.7 8.4a8 8 0 1 1-11.3 0z",
  language:
  ...
  providers:
    "m21 2-2 2m-7.6 7.6a5.5 5.5 0 1 1-7.8 7.8 5.5 5.5 0 0 1 7.8-7.8zm0 0L15.5 7.5m0 0 3 3L22 7l-3-3m-3.5 3.5L19 4",
  mcp: "M10 2v6L4 16v4h6v2l6-6V10l4-4V2h-6v4l-4 4V2z",
  servers: "M2 2h20v8H2zM2 14h20v8H2zM6 6h.01M6 18h.01",
  shortcuts:
  ...
  pet: "M4 11.5C4 7.9 7.6 5 12 5s8 2.9 8 6.5V16a3 3 0 0 1-3 3h-1.5l-1.2-2h-4.6l-1.2 2H7a3 3 0 0 1-3-3zM8 11h.01M16 11h.01M9 14c1.7 1.2 4.3 1.2 6 0",
  notifications: "M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9M13.7 21a2 2 0 0 1-3.5 0",
  updates: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3",
  config:
    "M8 3H7a2 2 0 0 0-2 2v5a2 2 0 0 1-2 2 2 2 0 0 1 2 2v5c0 1.1.9 2 2 2h1M16 3h1a2 2 0 0 1 2 2v5a2 2 0 0 0 2 2 2 2 0 0 0-2 2v5c0 1.1-.9 2-2 2h-1",
  diagnostics:
    "M12 3a7 7 0 0 0-7 7c0 2 .9 3.5 1.5 4.5L5 21h14l-1.5-6.5C18.1 13.5 19 12 19 10a7 7 0 0 0-7-7zM8.5 10h7",
};
...
export const SECTIONS: readonly SettingsSectionDef[] = [
  ...
  },
  {
    ...
    group: "app",
    iconPath: ICON_PATHS.appearance,
    keywords: [
      "theme",
      "accent",
      "color",
  ...
  },
  {
    ...
    group: "system",
    iconPath: ICON_PATHS.notifications,
  ...
  },
  {
    ...
    group: "advanced",
    iconPath: ICON_PATHS.diagnostics,
